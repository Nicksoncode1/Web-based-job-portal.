...
(3, 'Wipro Infotech', 'Mr. Alex Wainaina', 'Baroda', 'Baroda', 'alex@wipro.com', 8989898989, 'Hardware', 'Confirm', 'alex', 'alex', '', ''),
(4, 'Dr. Matress  Pvt Limited', 'Mr. Levi Soni', 'Levy', 'Mohamed', 'levi@gmail.com', 9898989898, 'Software', 'Confirm', 'levi', 'levi', 'What is Your Pet Name?', 'levi'),
(5, 'Info Matrics', 'Mr. Brian', 'Chomba', 'Chris', 'brayo@yahoo.com', 6767676767, 'Software', 'Confirm', 'brayo', 'brayo', 'What is Your Pet Name?', 'brayo');
...
(5, 3, 'asdad', '2023-09-13'),
(6, 3, 'asd', '2023-09-18'),
(7, 4, 'Thanks For Your Support.', '2023-09-18'),
(8, 3, 'asd', '2023-09-22');
...
(3, 3, 'B.C.A', 'Kenyatta Universiy', 2023, 68.89),
(4, 3, 'M.C.A', 'Zetech University', 2023, 89.9),
(5, 3, 'S.S.C', 'KCA University', 2023, 80);
...
(3, 'Mark Kibet', 'Near Dena Bank', 'Manasseh', 'mark@gmail.com', 9898989898, 'M.C.A', 'Male', '2023-09-10', 'Marksheet.pdf', 'Confirm', 'mark', 'mark', 'What is Your Pet Name?', 'mark'),
(4, 'Frankline Otieno', 'Western', 'Western', 'frank@gmail.com', 8989898989, 'M.B.A', 'Male', '2023-09-16', 'Marksheet.pdf', 'Confirm', 'frank','frank', '', ''),
(5, 'Linet Wanjiru', 'Kiserian', 'Kiserian', 'linet@gmail.com', 9898989898, 'MA', 'Female', '2023-10-15', 'admin.jpg', 'Confirm', 'linet', 'linet', '', ''),
(6, 'Anita Mistry', 'Bypass', 'Ruai', 'anita@gmail.com', 8989898998, 'BE', 'Female', '2023-10-09', '470X310_1.jpg', 'Confirm', 'anita', 'anita', 'What is Your Pet Name?', 'anita');
...
(1, 'Safaricom PLC job vacancies', '2024-02-23'),
(2, 'Fibre Networks new recruits', '2024-02-27'),
(3, 'New AI-based data Analyst', '2024-03-01');
...
(1, 'Wipro Infotech', 'Freshers Required', 5, 'B.C.A', 'Hardworking Person are Required.', '2023-09-01', '09:00:00'),
(2, 'TCS Private Limited', 'Marketive Representative Invited', 2, 'Pharmacist', 'Ready TO work in North Gujarat', '2023-10-01', '09:00:00');
